...
# parent folder.
#
# This file contains the QRtoAuth core implementation.
#
...
class QRtoAuthCore(object):
    '''
    QRtoAuth core implementation.
    This class provides the core functionality for the
    challenge response protocol.
    QRtoAuth is a challenge response protocol with symmetric
    keys.
    ...
    def set_challenge(self, challenge):
        ...
        :param str challenge: The QRtoAuth challenge.
        :rtype: void
        '''
    ...
    def get_challenge(self):
        '''
        Generate a QRtoAuth challenge.
        A QRtoAuth challenge consists of 128 random bits generated by PyCrypto
        with StrongRandom.
        These random bits are hashed with SHA512. This hash value represents
        the challenge.

        :return: A tuple containing the QRtoAuth challenge as well as the range
    ...
    def keygen(self):
        '''
        Generate the secret key for QRtoAuth aka shared secret.
        A QRtoAuth secret key consists of 256 random bits generated by PyCrypto
        with StrongRandom.
    ...
    def verify_response(self, received_otp, start, end):
        ...
        A QRtoAuth Response consists of 8 digests of the HMAC-SHA512 value
...
class AESCipher(object):
    '''
    AES cipher for QRtoAuth. AES is used to store the users shared_secret
